...
tests.test_rocket_silo = function(player)
  ...
  util_tests.assert_equal_position(item1.target.offset, {x = -.2475, y = 2}, serpent.line(item1.target.offset))
  util_tests.assert_equal_position(item2.target.offset, {x = 0.2475, y = 2}, serpent.line(item2.target.offset))
  util_tests.assert_equal_position(module.target.offset, {x = -0.825, y = 3.3}, serpent.line(module.target.offset))
...
tests.test_lab = function(player)
  ...
  assert(bg1.sprite == "alt-alt-entity-info-white-background", bg1.sprite)
  assert(bg2.sprite == "alt-alt-entity-info-white-background", bg2.sprite)
  util_tests.assert_equal_array(bg1.color, prototypes.quality["uncommon"].color, serpent.line(bg1.color))
  assert(module.sprite == "item.productivity-module", module.sprite)
  ...
  assert(item1.target.entity == entity, item1.target.entity.name)
  util_tests.assert_equal_position(item1.target.offset, {x = -12.5 / 11, y = -0.1}, serpent.line(item1.target.offset))
  util_tests.assert_equal_position(item2.target.offset, {x = 12.5 / 11, y = 401 / 990}, serpent.line(item2.target.offset))
  util_tests.assert_equal_position(module.target.offset, {x = -0.275, y = 0.9}, serpent.line(module.target.offset))
