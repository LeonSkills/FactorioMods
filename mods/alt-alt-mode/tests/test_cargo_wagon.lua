...
tests.test_dir_north_north_east = function(player)
  ...
  test.assert_sprite_equal(sprites[1],
                           {color = {a = 1, b = 0, g = 0, r = 0}, scale = 1.008, sprite = "alt-alt-entity-info-white-background", target = {entity, {1.158617162095851, 1.8193058459429778}}})
  ...
  test.assert_sprite_equal(sprites[4],
                           {color = {a = 1, b = 0, g = 0, r = 0}, scale = 1.008, sprite = "alt-alt-entity-info-white-background", target = {entity, {0.59714322069862646, 0.69758111531433542}}})
  ...
  test.assert_sprite_equal(sprites[7],
                           {color = prototypes.quality.uncommon.color, scale = 1.008, sprite = "alt-alt-entity-info-white-background", target = {entity, {0.035669279301373535, -0.42414361531433542}}})
  ...
  test.assert_sprite_equal(sprites[10],
                           {color = prototypes.quality.legendary.color, scale = 1.008, sprite = "alt-alt-entity-info-white-background", target = {entity, {-0.52580466209585097, -1.5458683459429778}}})
